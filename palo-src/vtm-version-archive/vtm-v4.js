...
/*        className={(i>this.props.value) ? 'point' : 'point fill'}       */
  ...
  //nebralo mi for v html
  //return(blabla {for} blabla);
  // A TERAZ MI ANI TOTO NEJDE!!
  renderPoints(){
    //debugger;
    for (var i = this.props.valueScale[0]; i<=this.props.valueScale[1];i++) this.renderPoint(i);
