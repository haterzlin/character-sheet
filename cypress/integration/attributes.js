describe('Attributes test', () => {
    ...
    it('But will add fill class to all previous dots aside from first', () => {                
    ...
    lvl3Attrs.forEach(element => {
        it('When we click on 5th dot of ' + element + ', only three dots are allowed', () => {                
            ...
            cy.contains(element).next().children().next().next().next().should('not.have.class', 'fill')
            ...
            cy.contains(element).next().children().first().should('not.have.class', 'fill')
            cy.contains(element).next().children().first().should('have.class', 'init')
        })
    })
    ...
    it('When we click on 5th dot of Resolve, no dots added', () => {                
        ...
        cy.contains('Resolve').next().children().next().next().next().should('not.have.class', 'fill')
        ...
        cy.contains('Resolve').next().children().first().should('not.have.class', 'fill')
        cy.contains('Resolve').next().children().first().should('have.class', 'init')
    })
