...
/**
 * need empty data to be able to change them later
 */
...
export const disciplines = {
  ...
  primaryDisciplines: { category: {id: 'Primary', description: 'Pick two of the Disciplines associated with your clan, and take two dots in one and one dot in the other.'}},
  secondaryDisciplines: { category: {id: 'Secondary', description: 'If you are Caitiff, thus having no clan, pick any two Disciplines you like and take two dots in one and one dot in the other.'}},
